...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
FIELD_2D::FIELD_2D(const int &rows, const int &cols) : _xRes(rows), _zRes(cols)
{
  _totalCells = _xRes * _zRes;
...
FIELD_2D::FIELD_2D(const FIELD_2D &m) : _xRes(m.xRes()), _zRes(m.zRes())
{
  _totalCells = _xRes * _zRes;
  _data = new float[_totalCells];
...
FIELD_2D::FIELD_2D() : _xRes(0), _zRes(0), _totalCells(0), _data(NULL)
{
}
...
///////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////
void FIELD_2D::resizeAndWipe(int xRes, int zRes)
{
  if (_xRes == xRes && _zRes == zRes) {
    clear();
    return;
  }
